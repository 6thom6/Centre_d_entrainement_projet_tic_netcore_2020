        ...
        public void Create(Soins NouveauSoins)
        {
            using (_connection)
            {
                ...
                SqlCommand command = new SqlCommand("INSERT INTO Soins (Id_Soins,Id_Cheval,Id_Employe," + //les champs de la table
                                                  ...
                                                  "Note_Libre,Marechal,Vermifuge, Type_de_soin, durrée_indisponibilité, date_de_soin)" +
        ...
        public void Update(Soins SoinsAModifier)
        {
            using (_connection)
            {
                ...
                SqlCommand command = new SqlCommand("UPDATE Soins SET Id_Cheval = @id_cheval" +
                    ...
                    "durrée_indisponibilité=@durrée_indisponibilité,date_de_soin=@date_de_soin" +
                ...
                command.Parameters.AddWithValue("durrée_indisponibilité", SoinsAModifier.durrée_indisponibilité);
