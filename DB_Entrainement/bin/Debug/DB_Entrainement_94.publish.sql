...
GO
PRINT N'Création de [dbo].[Employe]...';
...
CREATE TABLE [dbo].[Entrainement] (
    [Id_Entrainement]   INT           IDENTITY (1, 1) NOT NULL,
    ...
    CONSTRAINT [PK_Entrainement] PRIMARY KEY CLUSTERED ([Id_Entrainement] ASC)
);
...
CREATE TABLE [dbo].[mym_Vaccination_Cheval] (
    ...
    [Id_Cheval]      INT NOT NULL,
    CONSTRAINT [PK_mym_Vaccination_Cheval] PRIMARY KEY CLUSTERED ([Id_Vaccination] ASC)
);


GO
PRINT N'Création de [dbo].[Participe_Entrainement_cheval_employé]...';
...
CREATE TABLE [dbo].[Participe_Entrainement_cheval_employé] (
    ...
    CONSTRAINT [PK_Participe_Entrainement_cheval_employé] PRIMARY KEY CLUSTERED ([Id_Entrainement] ASC)
);
...
GO
PRINT N'Création de [dbo].[FK_mym_Vaccination_ToVaccination]...';


GO
ALTER TABLE [dbo].[mym_Vaccination_Cheval]
    ADD CONSTRAINT [FK_mym_Vaccination_ToVaccination] FOREIGN KEY ([Id_Vaccination]) REFERENCES [dbo].[Vaccination] ([Id_vaccination]);


GO
PRINT N'Création de [dbo].[FK_mym_Vaccination_ToCheval]...';


GO
ALTER TABLE [dbo].[mym_Vaccination_Cheval]
    ADD CONSTRAINT [FK_mym_Vaccination_ToCheval] FOREIGN KEY ([Id_Cheval]) REFERENCES [dbo].[Cheval] ([Id_Cheval]);


GO
PRINT N'Création de [dbo].[FK_Participe_Entrainement]...';


GO
ALTER TABLE [dbo].[Participe_Entrainement_cheval_employé]
    ADD CONSTRAINT [FK_Participe_Entrainement] FOREIGN KEY ([Id_Entrainement]) REFERENCES [dbo].[Entrainement] ([Id_Entrainement]);


GO
PRINT N'Création de [dbo].[FK_Participe_Cheval]...';


GO
ALTER TABLE [dbo].[Participe_Entrainement_cheval_employé]
    ADD CONSTRAINT [FK_Participe_Cheval] FOREIGN KEY ([Id_Cheval]) REFERENCES [dbo].[Cheval] ([Id_Cheval]);


GO
PRINT N'Création de [dbo].[FK_Participe_Employe]...';


GO
ALTER TABLE [dbo].[Participe_Entrainement_cheval_employé]
    ADD CONSTRAINT [FK_Participe_Employe] FOREIGN KEY ([Id_Employe]) REFERENCES [dbo].[Employe] ([Id_Employe]);
...
GO
ALTER TABLE [dbo].[Soins]
    ADD CONSTRAINT [FK_Soins_ToEmploye] FOREIGN KEY ([Id_Employe]) REFERENCES [dbo].[Employe] ([Id_Employe]);
...
END
GO
PRINT N'Création de [dbo].[CreateCourse]...';
...
END
GO
PRINT N'Création de [dbo].[CreateEmploye]...';
...
END
GO
PRINT N'Création de [dbo].[CreateEntrainement]...';
...
BEGIN
		INSERT INTO Entrainement (Cheval,Plat,Obstacle,Marcheur,Duree,Pre,Date_Entrainement)
		VALUES (@Cheval, @Plat, @Obstacle,@Marcheur,@Duree,@Pre,@Date_Entrainement)
END
GO
PRINT N'Création de [dbo].[CreateHistorique]...';
...
END
GO
PRINT N'Création de [dbo].[CreateProprietaire]...';
...
END
GO
PRINT N'Création de [dbo].[CreateSoins]...';
...
AS
	...
	END
GO
PRINT N'Création de [dbo].[CreateVaccination]...';
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'b9d95cce-d8c3-42ec-ab44-01f1449b7909')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('b9d95cce-d8c3-42ec-ab44-01f1449b7909')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '58d3bca7-d2d9-4940-af2d-64086967462d')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('58d3bca7-d2d9-4940-af2d-64086967462d')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'e89f0c8d-6a9c-4ccc-9c31-44ef59ce7ff0')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('e89f0c8d-6a9c-4ccc-9c31-44ef59ce7ff0')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '50d140f8-7c19-4e38-8448-22f5e75dc8b5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('50d140f8-7c19-4e38-8448-22f5e75dc8b5')
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'a2c07d47-469f-4f5a-aadb-b729319222b2')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('a2c07d47-469f-4f5a-aadb-b729319222b2')
...
values 
('dala','1000m','2tours','none','2h','none','2020-09-12'),
('khani','1500m','3tours','none','2h','none','2020-08-21'),
('zarkandar','2000m','6tours','none','2h30','none','2020-07-14'),
('dubawi','3500m','2tours','none','2h','none','2020-09-12'),
('alpha spirit','3000m','none','2h','1h','none','2020-09-17')
