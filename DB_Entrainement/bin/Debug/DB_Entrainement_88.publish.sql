...
CREATE PROCEDURE [dbo].[CreateSoins]
	@Id_Cheval int,
 	@Id_Employe int,
	@Vermifuge DATE,
	@Marechatl_Derniere_Visite DATE,
	@Note_Libre NVARCHAR (max),
	@Type_De_Soin NVARCHAR (50),
	@Duree_Indisponibilite NVARCHAR (50),
	@Date_De_Soin DATE,
...
AS
	BEGIN
			...
			VALUES (@Id_Cheval, @Id_Employe, @Vermifuge, @Marechatl_Derniere_Visite, @Note_Libre, @Type_De_Soin, @Duree_Indisponibilite, @Date_De_Soin, @Alimentation, @Complement_Alimentation)
	END
GO
