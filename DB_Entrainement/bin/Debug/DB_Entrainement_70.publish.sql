...
AS
BEGIN
    INSERT INTO Cheval (Nom_cheval, Pere_cheval, Mere_cheval, Sortie_provisoire, Raison_Sortie, Id_Proprietaire, Id_Soins, Poids, Race, Age)
    VALUES (@Nom_Cheval, @Pere_Cheval, @Mere_Cheval, @Sortie_Provisoire, @raison_sortie, @Id_Proprietaire, @Id_Soins, @Poids, @Race, @Age);
END
GO
