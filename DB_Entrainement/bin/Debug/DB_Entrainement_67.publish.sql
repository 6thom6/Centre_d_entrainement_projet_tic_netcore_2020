...
INSERT INTO [dbo].[Cheval] ([dbo].[Cheval].[Nom_cheval],
                            ...
                            [dbo].[Cheval].[Poids],
                            [dbo].[Cheval].[Race],
                            [dbo].[Cheval].[Alimentation],
                            [dbo].[Cheval].[complement_Alimentation],
                            [dbo].[Cheval].[Age])
VALUES  
('dala','dalakhani','zarkava','2020-07-02','repos','1','1','450','PS','3litres','none','4'),
('khani','dalakhani','zarkava','2020-07-12','repos','2','2','450','PS','1litres','warning','5'),
('zarkandar','dalakhani','zarkava','2020-11-02','repos','3','3','450','PS','2litres','none','3'),
('dubawi','dalakhani','zarkava','2020-05-02','repos','1','4','450','PS','1litres','none','6'),
('alpha spirit','zarak','zarkava','2020-09-24','repos','3','5','450','PS','2litres','none','4');
