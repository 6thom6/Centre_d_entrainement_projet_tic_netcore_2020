...
GO
PRINT N'Création de [dbo].[mym_Cheval_Employe]...';


GO
CREATE TABLE [dbo].[mym_Cheval_Employe] (
    [MYM_Chevalid_Cheval]   INT NOT NULL,
    [Mym_Employeid_Employe] INT NOT NULL
);
...
GO
PRINT N'Création de [dbo].[FK_mym_Cheval_]...';


GO
ALTER TABLE [dbo].[mym_Cheval_Employe]
    ADD CONSTRAINT [FK_mym_Cheval_] FOREIGN KEY ([MYM_Chevalid_Cheval]) REFERENCES [dbo].[Cheval] ([Id_Cheval]);


GO
PRINT N'Création de [dbo].[FK_mym_Cheval_Entrainement]...';


GO
ALTER TABLE [dbo].[mym_Cheval_Employe]
    ADD CONSTRAINT [FK_mym_Cheval_Entrainement] FOREIGN KEY ([Mym_Employeid_Employe]) REFERENCES [dbo].[Employé] ([Id_Employé]);
...
[dbo].[Entrainement].[Marcheur],[dbo].[Entrainement].[Durée],[dbo].[Entrainement].[Pré],
...
insert mym_Cheval_Employe (MYM_Chevalid_Cheval,Mym_Employeid_Employe)
values
('5','1'),
('4','2'),
('3','4'),
