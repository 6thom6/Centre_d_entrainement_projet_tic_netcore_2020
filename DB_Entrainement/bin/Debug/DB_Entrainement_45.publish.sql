/*
Script de déploiement pour DB_Entrainement_Full
...
GO
:setvar DatabaseName "DB_Entrainement_Full"
:setvar DefaultFilePrefix "DB_Entrainement_Full"
...
insert mym_Vaccination_Cheval (Id, ChevalId_Cheval, VaccinationId_Vaccination)
values
...
insert mym_Cheval_Entrainement (Id,MYM_ChevaliId_Cheval,MYM_Entrainementid_Entrainement)
values
('1','1','1'),
('2','2','2'),
('3','3','3'),
...
insert mym_Course_cheval (ChevalId_Cheval, CoursesId_Course, Id)
values
('1','1','1'),
('2','2','2'),
('3','3','3'),
