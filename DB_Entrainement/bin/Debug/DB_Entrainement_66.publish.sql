...
insert into [dbo].[Entrainement] ([dbo].[Entrainement].[Cheval],[dbo].[Entrainement].[Plat],[dbo].[Entrainement].[Obstacle],
...
insert into [dbo].[Course] ([dbo].[Couse].[Hippodrome], [dbo].[Couse].[Date_Courses],[dbo].[Couse].[Distance],[dbo].[Couse].[Corde],[dbo].[Couse].[Discipline],
...
insert into [dbo].[Employé] ([dbo].[Employé].[Nom_Employe], [dbo].[Employé].[Date_Embauche], [dbo].[Employé].[Statuts_Employe])
values
...
insert [dbo].[Vaccination]([dbo].[Vaccination].[Nom_vaccin],[dbo].[Vaccination].[Delai_Indisponibilite])
values
('polyo','2020-10-10'),
('polyo','2020-10-12'),
('polyo','2020-10-13'),
...
insert [dbo].[Proprietaire]([dbo].[Proprietaire].[Nom_Proprietaire],[dbo].[Proprietaire].[Date_Arrivee],[dbo].[Proprietaire].[Dernier_Resultat])
values
...
insert [dbo].[Historique] ([dbo].[Historique].[Id_Cheval],[dbo].[Historique].[Debourage],[dbo].[Historique].[Pre-entrainement],[dbo].[Historique].[Entraineur_precedent],[dbo].[Historique].[Proprietaire_precedent])
values
