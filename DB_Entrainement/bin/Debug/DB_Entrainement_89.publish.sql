...
AS
	BEGIN
			...
			VALUES (@Id_Cheval, @Id_Employe, @Vermifuge, @Marechal_Derniere_Visite, @Note_Libre, @Type_De_Soin, @Duree_Indisponibilite, @Date_De_Soin, @Alimentation, @Complement_Alimentation)
	END
GO
