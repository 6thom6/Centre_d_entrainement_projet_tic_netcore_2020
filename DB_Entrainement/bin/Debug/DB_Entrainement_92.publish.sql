...
GO
PRINT N'Création de [dbo].[mym_Employe_Entrainement]...';
...
GO
ALTER TABLE [dbo].[mym_Cheval_Entrainement]
    ADD CONSTRAINT [FK_mym_Cheval_Entrainement_ToEntrainement] FOREIGN KEY ([MYM_Entrainementid_Entrainement]) REFERENCES [dbo].[Entrainement] ([Id_Entrainement]);
...
GO
PRINT N'Création de [dbo].[FK_mym_Employe_Entrainement_ToEntrainement]...';


GO
ALTER TABLE [dbo].[mym_Employe_Entrainement]
    ADD CONSTRAINT [FK_mym_Employe_Entrainement_ToEntrainement] FOREIGN KEY ([EntrainementID_Entrainement]) REFERENCES [dbo].[Entrainement] ([Id_Entrainement]);


GO
PRINT N'Création de [dbo].[FK_mym_Employe_Entrainement_ToEmploye]...';


GO
ALTER TABLE [dbo].[mym_Employe_Entrainement]
    ADD CONSTRAINT [FK_mym_Employe_Entrainement_ToEmploye] FOREIGN KEY ([EmployeID_Employe]) REFERENCES [dbo].[Employe] ([Id_Employe]);
