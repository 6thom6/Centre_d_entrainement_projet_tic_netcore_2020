...
CREATE TABLE [dbo].[Participe_Entrainement_cheval_employé] (
    ...
    CONSTRAINT [PK_Participe_Entrainement_cheval_employé] PRIMARY KEY CLUSTERED ([Id_Entrainement] ASC, [Id_Cheval] ASC, [Id_Employe] ASC)
);
...
GO
PRINT N'Création de [dbo].[V_Coursecomplet]...';
...
GO
PRINT N'Création de [dbo].[V_entrainementcomplet]...';
