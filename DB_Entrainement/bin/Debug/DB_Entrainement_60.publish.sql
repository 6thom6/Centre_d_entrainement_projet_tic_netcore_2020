...
CREATE TABLE [dbo].[Vaccination] (
    ...
    [Delai_Indisponibilite] DATE          NOT NULL,
...
insert into [dbo].[Employé] ([dbo].[Employé].[Id_Employe], [dbo].[Employé].[Nom_Employé], [dbo].[Employé].[Date_Embauche], [dbo].[Employé].[Statuts_Employe])
values
...
date_de_soin,Type_de_soin,durree_indisponibilite)
values
