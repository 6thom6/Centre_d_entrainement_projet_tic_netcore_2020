...
insert into [dbo].[Entrainement] ([dbo].[Entrainement].[Id_Entainement],
[dbo].[Entrainement].[Cheval],[dbo].[Entrainement].[Plat],[dbo].[Entrainement].[Obstacle],
[dbo].[Entrainement].[Marcheur],[dbo].[Entrainement].[Duree],[dbo].[Entrainement].[Pre],
[dbo].[Entrainement].Id_Employe)
values 
('1','dala','1000m','2tours','none','2h','none','1'),
('2','khani','1500m','3tours','none','2h','none','2'),
('3','zarkandar','2000m','6tours','none','2h30','none','3'),
('4','dubawi','3500m','2tours','none','2h','none','4'),
('5','alpha spirit','3000m','none','2h','1h','none','5')
...
insert into [dbo].[Employé] ([dbo].[Employé].[Id_Employe], [dbo].[Employé].[Nom_Employe], [dbo].[Employé].[Date_Embauche], [dbo].[Employé].[Statuts_Employe])
values
...
insert [dbo].[Vaccination]([dbo].[Vaccination].[Id_vaccination],[dbo].[Vaccination].[Nom_vaccin],[dbo].[Vaccination].[Delai_Indisponibilite])
values
('1','polyo','2020-10-10'),
('5','polyo','2020-10-12'),
('3','polyo','2020-10-13'),
...
insert [dbo].[Proprietaire]([dbo].[Proprietaire].[Id_Proprietaire],[dbo].[Proprietaire].[Nom_Proprietaire],[dbo].[Proprietaire].[Date_Arrivee],[dbo].[Proprietaire].[Dernier_Resultat])
values
('10','nicole','2020-12-05','1er'),
('20','papot','2020-06-03','1er'),
('30','schule','2020-08-04','2eme'),
('40','Delay','2020-07-05','np'),
('50','deWaele','2020-10-15','np')



INSERT INTO [dbo].[Cheval] ([dbo].[Cheval].[Nom_cheval],[dbo].[Cheval].[Pere_cheval],[dbo].[Cheval].[Mere_cheval],
...
VALUES  
('dala','dalakhani','zarkava','2020-07-02','repos','10','10','450','PS','3litres','none','4'),
('khani','dalakhani','zarkava','2020-07-12','repos','20','20','450','PS','1litres','warning','5'),
('zarkandar','dalakhani','zarkava','2020-11-02','repos','30','30','450','PS','2litres','none','3'),
('dubawi','dalakhani','zarkava','2020-05-02','repos','10','40','450','PS','1litres','none','6'),
('alpha spirit','zarak','zarkava','2020-09-24','repos','30','50','450','PS','2litres','none','4');
...
date_de_soin,Type_de_soin,durree_indisponibilite,Alimentation,Complement_Alimentation)
values
('1','10','4','2020-01-25','2020-09-10','complet','2020-09-10','infiltration_ant_d','7j','2litres','rien'),
('1','20','2','2020-04-07','2020-08-11','complet','2020-08-11','fracture_ant_g','15mois','2litres','foin'),
('2','30','2','2020-03-25','2020-07-15','complet','2020-07-15','tendinite_pos_d','1mois','2litres','granullé'),
('4','40','4','2020-01-15','2020-06-04','complet','2020-06-04','infiltration_ant_d','12j','2litres','orge'),
('3','50','5','2020-06-25','2020-09-10','complet','2020-09-10','fracture_pos_g','1an','2litres','sucre_paille'),
('1','11','5','2020-05-23','2020-05-23','complet','2020-05-23','tendinite_pos_d','12j','2litres','poudre'),
('1','12','2','2020-05-23','2020-06-12','complet','2020-06-12','fracture_pos_g','','2litres','avoine'),
('1','13','1','2020-05-23','2020-07-11','complet','2020-07-11','tendinite_Ant_g','1mois','2litres','maïs'),
('1','14','3','2020-05-23','2020-08-12','complet','2020-08-12','infiltration_Pos_d','15j','2litres','poivre'),
('1','15','3','2020-05-23','2020-05-13','complet','2020-05-13','fracture_Anterieur_g','6mois','2litres','sel')




insert [dbo].[Historique] ([dbo].[Historique].[Id_historique],[dbo].[Historique].[Id_Cheval],[dbo].[Historique].[Debourage],[dbo].[Historique].[Pre-entrainement],[dbo].[Historique].[Entraineur_precedent],[dbo].[Historique].[Proprietaire_precedent])
values
