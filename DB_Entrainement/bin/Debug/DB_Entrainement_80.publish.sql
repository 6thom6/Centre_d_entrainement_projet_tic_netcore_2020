...
ALTER TABLE [dbo].[mym_Employe_Entrainement]
    ADD CONSTRAINT [FK_mym_Employe_Entrainement_ToEntrainement] FOREIGN KEY ([EntrainementID_Entrainement]) REFERENCES [dbo].[Entrainement] ([Id_Entainement]);
